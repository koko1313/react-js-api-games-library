  ...
  return <>
    ...
    <div className="row">
      <div className="col-md">
        <h2>За проекта</h2>
        <p>
          Библиотека с игри, направена на <a href="https://reactjs.org/">Reat.js</a>.<br /><br />
          Това е курсов проект, използващ външно API <a href="https://api.rawg.io/docs/">rawg.io</a>, предоставящо информацията за всички игри.<br />
      ...
      <div className="col-md">
        <h2>За мен</h2>
        <p>
          <strong>Име: </strong> <em><a href="http://portfolio.koko.projects.bgschool.bg/">Калоян Величков</a></em><br />
